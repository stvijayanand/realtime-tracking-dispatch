...
var allEnvVars = []struct {
	...
	{"KAFKA_TOPIC_RIDE_EVENTS", func(c config.Config) string { return c.KafkaTopic }},
	...
	{"KAFKA_CONSUMER_GROUP_ID", func(c config.Config) string { return c.KafkaConsumerGroupID }},
