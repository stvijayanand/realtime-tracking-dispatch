...
// Gateway Service. Every field is mandatory — LoadConfig exits non-zero if any
// variable is absent (Requirements 9.1, 10.10).
type Config struct {
	...
	// ServicePort is the TCP port the HTTP/WebSocket server listens on (e.g. "8003").
...
// descriptive error identifying the missing variable and calls os.Exit(1).
