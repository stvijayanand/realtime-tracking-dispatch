...
- **OpenAPI_Spec**: The machine-readable API description (OpenAPI 3.x JSON/YAML) generated from and committed alongside each service that exposes HTTP endpoints — including both Go services and the Spring Boot Dispatch_Service.
